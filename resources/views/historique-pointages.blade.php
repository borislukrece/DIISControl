    ...
    <section>
        ...
        ">
            ...
            ">
                <div>
                    {{-- HEADER--}}
                    <div class="w-full h-16 bg-white/[0.8] shadow">
                    ...
                    <div class="w-full min-h-full bg-white/[0.6] flex items-center justify-center">
                        {{-- BODY --}}
                                        ...
                                        <div class="w-full h-auto flex sm:flex-row justify-between max-sm:flex-col max-sm:items-center max-sm:justify-center">
                                            <div class="h-auto flex items-center">
                                                <div class="h-12 ml-4 flex">
                                                    <a href="historique-pointages?&agent={{$id_agent}}<?php if(isset($_GET['date']) && isset($_GET['date'])){ echo "&date=".valid_donnees($_GET['date']); } ?>" class="p-3 mr-1 rounded-lg text-sm h-12 bg-opacity-60 bg-black/[0.162] flex items-center justify-center" style="
                                                    ...
                                                    <a href="historique-pointages?filter=month&agent={{$id_agent}}<?php if(isset($_GET['date']) && isset($_GET['date'])){ echo "&date=".valid_donnees($_GET['date']); } ?>" class="p-3 mr-1 rounded-lg text-sm h-12 bg-opacity-60 bg-black/[0.162] flex items-center justify-center" style="
                                                        @if ($filter === 'month')
                                                        background: #EC9728C6;
                                                        @endif
                                                    ">
                                                    ...
                                                    <a href="historique-pointages?filter=year&agent={{$id_agent}}<?php if(isset($_GET['date']) && isset($_GET['date'])){ echo "&date=".valid_donnees($_GET['date']); } ?>" class="p-3 mr-1 rounded-lg text-sm h-12 bg-opacity-60 bg-black/[0.162] flex items-center justify-center" style="
                                                        @if ($filter === 'year')
                                                        background: #EC9728C6;
                                                        @endif
                                                    ">
