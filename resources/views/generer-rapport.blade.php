            ...
            <div class="w-full h-full">
                <div class="w-full h-full">
                    <div class="w-full h-full flex">
                        <div class="w-full h-full p-4 bg-white/80">
                            <div class="w-full h-full">
                                <div><img src="{{'/img/logo.png'}}" alt="logo" width="100" height="100"></div>
                                <div class="font-bold text-2xl">Rapport Individuel <span class="text-gray-500">({{ strtoupper($agent->nom) }} {{ $agent->prenom }})</span> | <span class="select_date">{{getMoisLetter($SET_MONTH,$SET_YEAR)}} {{$SET_YEAR}}</span></div>
